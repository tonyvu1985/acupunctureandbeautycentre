		...
		<div id="ithemes-updater-settings">
			...
			<table class="form-table">
				<tbody>
					<tr valign="top">
						<th scope="row">
							<label for="show_on_sites"><?php _e( 'Licensing Page Access', 'it-l10n-backupbuddy' ); ?></label>
						</th>
						<td>
							...
							<label>
								...
								<?php _e( 'Show this licensing page on site dashboards', 'it-l10n-backupbuddy' ); ?>
							</label>
							
							<p class="description"><?php _e( 'By default, this page only shows on the network dashboard. Enable the option above in order to have this page accessible on sites as well.', 'it-l10n-backupbuddy' ); ?></p>
						</td>
					</tr>
				</tbody>
			</table>
