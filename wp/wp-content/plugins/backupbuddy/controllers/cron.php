...
class pb_backupbuddy_cron extends pb_backupbuddy_croncore {
	...
	public function destination_send( $destination_settings, $files, $send_id = '' ) {
		...
		pb_backupbuddy::$classes['core']->destination_send( $destination_settings, $files, $send_id );
	...
	function process_destination_copy( $destination_settings, $remote_file ) {
		...
		$local_file = pb_backupbuddy::$options['backup_directory'] . basename( $remote_file );
