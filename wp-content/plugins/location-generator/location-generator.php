...
function location_gen_page()
{
	...
	// Print warning if Exclude Pages plugin is not active
	if (!function_exists('ep_exclude_pages'))
		echo '<div class="error"><strong>Exclude Pages</strong> plugin has not been installed/activated. You can still generate pages, but they will appear in the main nav unless you use a custom menu.</div>';
