...
jQuery('.themes-php #message2').html(message);
                ...
                var jetpack_message = '<div class="updated below-h2" id="message2" style="padding:10px"><p><strong>Attention:</strong><br /><br />We\'ve detected that the JetPack Plugin is currently installed.</p><p>If you wish to use SKTthemes\'s built-in Form Builder you will first need to disable the JetPack Contact Form, Publicize and Sharing modules.</p></div>';
