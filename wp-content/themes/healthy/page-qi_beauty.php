...
<div id="right-column">
    <div id="content-wrapper">
        <div id="post-content">
        	<h1 style="font-weight:bold; font-size:18px">Qi Beauty</h1>
            <div class="list-acupunture">
                <ul>
                    <?php query_posts('post_type=page&post_parent=135&order=ASC&orderby=menu_order');?>   
